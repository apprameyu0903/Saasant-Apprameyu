 ...
 * Generated at: 2025-05-18 18:19:57 UTC
...
public final class customer_005fdetails_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("        console.log(\"Data received by fillCustomerTable:\", JSON.parse(JSON.stringify(customersList)));\n");
      ...
      out.write("            customersList.forEach(function(oneCustomer, index) {\n");
      out.write("                console.log('Populating row for customer at index ' + index + ':', JSON.parse(JSON.stringify(oneCustomer)));\n");
      out.write("\n");
      out.write("                const displayId = oneCustomer.customerId;\n");
      out.write("                const displayName = oneCustomer.customerName;\n");
      out.write("                const displayMobile = oneCustomer.mobileNumber;\n");
      out.write("                const displayLocation = oneCustomer.customerLocation;\n");
      out.write("                \n");
      out.write("                var tableRowHtml = '<tr id=\"customerRow-' + (oneCustomer.customerId || 'temp-id-' + index) + '\">'; // Use actual ID or a temp one\n");
      out.write("                tableRowHtml += '<td>' + displayId + '</td>';\n");
      out.write("                tableRowHtml += '<td class=\"name\">' + displayName + '</td>';\n");
      out.write("                tableRowHtml += '<td class=\"mobile\">' + displayMobile + '</td>';\n");
      out.write("                tableRowHtml += '<td class=\"location\">' + displayLocation + '</td>';\n");
      out.write("                tableRowHtml += '<td>';\n");
      out.write("                tableRowHtml += '<a class=\"action-link edit-link text-primary mr-2\" href=\"#\" data-id=\"' + oneCustomer.customerId + '\">Edit</a>';\n");
      out.write("                tableRowHtml += '<a class=\"action-link delete-link text-danger\" href=\"#\" data-id=\"' + oneCustomer.customerId + '\">Delete</a>';\n");
      out.write("                tableRowHtml += '</td>';\n");
      out.write("                tableRowHtml += '</tr>';\n");
      out.write("                \n");
      ...
      out.write("        console.log(\"Delete button clicked. Customer ID from data-id:\", customerIdToDelete, \"(type: \" + typeof customerIdToDelete + \")\");\n");
      out.write("        const customerName = $(this).closest(\"tr\").find(\".name\").text();\n");
      out.write("\n");
      out.write("        if (!customerIdToDelete || String(customerIdToDelete).toLowerCase() === \"null\" || String(customerIdToDelete).toLowerCase() === \"undefined\" || String(customerIdToDelete).trim() === \"\") {\n");
      out.write("            showAlertRevised(\"Cannot delete: Customer ID is missing or invalid.\", \"danger\");\n");
      out.write("            return;\n");
      out.write("        }\n");
      out.write("\n");
      out.write("        if (confirm(`Are you sure you want to delete customer: ` + customerName + ` (ID: ` + customerIdToDelete+ `)?`)) {\n");
      out.write("            console.log(\"Proceeding to delete customer ID:\", customerIdToDelete);\n");
      out.write("\n");
      out.write("            const deleteUrl = API_BASE_URL + `/` + customerIdToDelete; \n");
      out.write("            console.log(\"AJAX Delete URL being called:\", deleteUrl); \n");
      out.write("\n");
      out.write("            $.ajax({\n");
      out.write("                url: deleteUrl, \n");
      out.write("                type: \"DELETE\",\n");
      out.write("                success: function(response, status, xhr) {\n");
      out.write("                    console.log(\"Delete successful for ID:\", customerIdToDelete, \"Status:\", status);\n");
      ...
      out.write("                },\n");
      out.write("                error: function(xhr) {\n");
      out.write("                    console.error(\"Delete error for ID:\", customerIdToDelete, \"Status:\", xhr.status, \"Response:\", xhr.responseText);\n");
      ...
      out.write("                        errorMsg = \"Customer not found for deletion (404).\";\n");
      out.write("                    } else if (xhr.status === 405) { \n");
      out.write("                        errorMsg = \"Method Not Allowed (405). The server endpoint does not support DELETE or the URL is incorrect.\";\n");
      out.write("                    }\n");
      out.write("                     else if (xhr.statusText) { \n");
      out.write("                         errorMsg += \" Server responded: \" + xhr.statusText + \" (Status: \" + xhr.status + \")\";\n");
      out.write("                    }\n");
      ...
      out.write("        $.ajax({\n");
      out.write("            url: API_BASE_URL + `/`+ customerIdToEdit, \n");
      out.write("            type: \"GET\",\n");
      out.write("            dataType: \"json\",\n");
      ...
      out.write("\n");
      out.write("        $.ajax({\n");
      out.write("            url: API_BASE_URL + `/` + customerId,\n");
      out.write("            type: \"PUT\",\n");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /customer_details.jsp(26,12) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /customer_details.jsp(32,12) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /customer_details.jsp(60,29) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setVar("customer");
    // /customer_details.jsp(60,29) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/customer_details.jsp(60,29) '${customers}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${customers}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
